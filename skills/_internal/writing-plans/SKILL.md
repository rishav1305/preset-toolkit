...
The change description should come from a brainstorming session (`_internal/brainstorming`) or the user's direct request.
...
When the plan is approved by the user, hand off to `_internal/executing-plans` for execution.
